...
图片在attachments文件夹中
## 余子式函数minor_matrix：
为了方便求解，编写了一个生成余子式的函数：
![[Pasted image 20250503212314.png|400]]
![[Pasted image 20250503212254.png|400]]
## 计算行列式
...
移动文件位置后再次build，遇到报错：
```
CMake Error: The source "D:/X-lab/C_demo/CMakeLists.txt" does not match the source "D:/rubisco/ZJU/X-lab/C_demo/CMakeLists.txt" used to generate cache. Re-run cmake with a different source directory.
```
原因为：
之前在 `D:/rubisco/ZJU/X-lab/C_demo/` 目录里运行过 `cmake`，CMake 生成了一个 缓存。
...
![[Pasted image 20250503193002.png]]
## sub_matrix
...
4.00    5.00    
5.00    9.00
Error: Matrix a and b must have the same rows and cols.s
![[Pasted image 20250503193127.png]]
## mul_matrix
输入：
*
2 3
...
![[Pasted image 20250503193152.png]]
## scale_matrix
输入：
.
2 3
...
2.00    4.00    6.00
8.00    10.00   12.00
![[Pasted image 20250503193615.png]]
## transpose_matrix
输入：
t
2 3
...
2.00    5.00
3.00    6.00
![[Pasted image 20250503194550.png]]
## trace_matrix
输入：
j
3 3
...
0.00
![[Pasted image 20250503194812.png]]
## det_matrix
输入：
d
3 3
...
![[Pasted image 20250503210328.png]]
## inv_matrix
 输入：
 i
2 2
4.00  7.00
2.00  6.00
![[Pasted image 20250503215039.png]]
## rank_matrix
r
3 3
1 2 3
...
rank = 2
![[Pasted image 20250503221457.png]]
